...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jhitest@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jhitest API";

        private String description = "jhitest API documentation";
